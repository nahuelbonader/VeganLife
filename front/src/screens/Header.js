...
const Header = ({ scene, previous }) => {
  ...
  const handleSubmit = () => {
    //handleSubmit busca si existe coincidencias entre la variable Term y el Title o Name de X obj a buscar
  ...
  return (
    <Appbar.Header
      style={currentRoute.route == 3 ? styles.backTwo : styles.back}
    >
      {previous ? (
      ...
      <View>
        ...
        {currentRoute.route == 3 ? (
          <View style={styles.view}>
            <TouchableOpacity
              onPress={() => {
                if (!active1) setValue("recipes"), handlePress(setActive1);
              }}
            >
            ...
            <TouchableOpacity
              onPress={() => {
                if (!active2) setValue("users"), handlePress(setActive2);
              }}
            >
            ...
            <TouchableOpacity
              onPress={() => {
                if (!active3) setValue("stores"), handlePress(setActive3);
              }}
            >
            ...
            <TouchableOpacity
              onPress={() => {
                if (!active4) setValue("products"), handlePress(setActive4);
              }}
            >
              <Text style={active4 ? styles.touchActive : styles.touch1}>
                Productos
              </Text>
            </TouchableOpacity>
          </View>
