...
import useInputs from "../hooks/useInputsHours";
...
const MyCommerce = ({ myImage, myName, userId, stores, imAdminIn }) => {
  ...
  const handleSubmit = () => {
    const daysOpen = [
      {
        open: open1,
        startMorning: `${domingoAm1}:${domingoAm2}`,
        endMorning: `${domingoAm1c}:${domingoAm2c}`,
        startNoon: `${domingoPm1}:${domingoPm2}`,
        endNoon: `${domingoPm1c}:${domingoPm2c}`,
      },
      {
        open: open2,
        startMorning: `${lunesAm1}:${lunesAm2}`,
        endMorning: `${lunesAm1c}:${lunesAm2c}`,
        startNoon: `${lunesPm1}:${lunesPm2}`,
        endNoon: `${lunesPm1c}:${lunesPm2c}`,
      },
      {
        open: open3,
        startMorning: `${martesAm1}:${martesAm2}`,
        endMorning: `${martesAm1c}:${martesAm2c}`,
        startNoon: `${martesPm1}:${martesPm2}`,
        endNoon: `${martesPm1c}:${martesPm2c}`,
      },
      {
        open: open4,
        startMorning: `${miercolesAm1}:${miercolesAm2}`,
        endMorning: `${miercolesAm1c}:${miercolesAm2c}`,
        startNoon: `${miercolesPm1}:${miercolesPm2}`,
        endNoon: `${miercolesPm1c}:${miercolesPm2c}`,
      },
      {
        open: open5,
        startMorning: `${juevesAm1}:${juevesAm2}`,
        endMorning: `${juevesAm1c}:${juevesAm2c}`,
        startNoon: `${juevesPm1}:${juevesPm2}`,
        endNoon: `${juevesPm1c}:${juevesPm2c}`,
      },
      {
        open: open6,
        startMorning: `${viernesAm1}:${viernesAm2}`,
        endMorning: `${viernesAm1c}:${viernesAm2c}`,
        startNoon: `${viernesPm1}:${viernesPm2}`,
        endNoon: `${viernesPm1c}:${viernesPm2c}`,
      },
      {
        open: open7,
        startMorning: `${sabadoAm1}:${sabadoAm2}`,
        endMorning: `${sabadoAm1c}:${sabadoAm2c}`,
        startNoon: `${sabadoPm1}:${sabadoPm2}`,
        endNoon: `${sabadoPm1c}:${sabadoPm2c}`,
      },
    ];
  ...
  return (
    <View style={styles.container}>
        ...
        {message ? (
          ...
          <>
            <Image
              ...
              source={{ uri: myImage ? myImage : userIcon }}
            />
      ...
      <View style={styles.viewOptions}>
        ...
        >
          <Text style={active1 ? styles.touchActive : styles.touch1}>
            Mis comercios
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={active2 ? styles.touchActive : styles.touch1}>
            Trabajo en
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={active3 ? styles.touchActive : styles.touch1}>
            Crear comercio
          </Text>
        </TouchableOpacity>
      </View>
          ...
          <View>
            ...
            <View style={styles.row}>
              ...
              <RadioButton
                ...
                onPress={() => {
                  setChecked("first"), setDelivery(false);
                }}
              />
              <Text>Si</Text>
              <RadioButton
                ...
                onPress={() => {
                  setChecked("second"), setDelivery(true);
                }}
              />
            </View>
            <TouchableOpacity style={styles.submit} onPress={goNext}>
